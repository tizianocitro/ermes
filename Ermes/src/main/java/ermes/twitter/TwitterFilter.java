    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            if (twitter.isTokenGiven(httpRequest.getParameter(TwitterService.TWITTER_ACCESS_TOKEN),
                ...
                if (!twitter.verifyConnectionParameters(
                		httpRequest.getParameter(TwitterService.TWITTER_TOKEN),
                    ...
                    httpResponse.sendRedirect(
                    		twitter.getAuthUrl(httpRequest.getParameter(TwitterService.TWITTER_KEY),
            ...
            httpRequest.setAttribute(TwitterService.TWITTER_ERROR, TwitterUtils.format(e.getMessage()));
